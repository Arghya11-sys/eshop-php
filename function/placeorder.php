...
if(isset($_SESSION['auth']))
{
        if(isset($_POST['placeOrderBtn']))
        {
           ...
           // $cartItems = getCartItems();
            ...
            $tracking_no = "ecom".rand(1111,9999).substr($phone,2);
            ...
            if($insert_query_run)
            {
                ...
                $delete_Carts_Query = "DELETE FROM carts WHERE user_id = '$userId'";
                $delete_Carts_Query_run = mysqli_query($con, $delete_Carts_Query);
